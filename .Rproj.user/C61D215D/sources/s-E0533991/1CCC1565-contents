...
d = read.csv("Data/Presenter-Judges_FSPB+CJ+Gaze(10Hz)+Blink_TimeSeries_ALLStats_AllT_1HzMean_v3.csv")
...
sink(paste0("Logs/BlinkSummary_TreatmentLevel_v3.txt"))
...
write.csv(f, "Data/Blink+Gaze_Summary_TreatmentLevel_v3.csv", row.names = F)
